...
% initial value c and calcuates the error for the boundary value condition
% at x=L
...
%this make a plot of th solution for this value of c
Nb = alp*L;
plot(X,S(:,2),[Nb,Nb],[0,c],'--','linewidth',2)
