...
if(~isempty(ndx2)) 
    plot(1./b1(ndx2),1./onebyxi1(ndx2))
end
...
text(1.9,1.8,'\{V_p\}','fontsize',18)
text(3,1,'\{\infty\}','fontsize',18)
text(3,2.5,'\{0,\infty\}','fontsize',18)
 
 figure(5)
plot([0,4],[0,4],'--',[0,4],[1/U0,1/U0],'--',1/p.b,p.xi,'*')

  
hold off
 legend('boxoff')
legend([ln(1),ln(2),ln(3)],'\alpha = 0.6','\alpha = 0.8','\alpha = 1.0','fontsize',18,'location','northwest')
