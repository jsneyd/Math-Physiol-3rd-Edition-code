...
figure(1);
     subplot(2,2,1),plot(T,V,'linewidth',2),xlabel('time(ms)','linewidth',2); ylabel('V');
     subplot(2,2,2),plot(T,m,'linewidth',2),xlabel('time(ms)','linewidth',2); ylabel('m');
     subplot(2,2,3),plot(T,h,'linewidth',2),xlabel('time(ms)','linewidth',2); ylabel('h');
     subplot(2,2,4),plot(T,j,'linewidth',2),xlabel('time(ms)','linewidth',2); ylabel('j');
figure(2)
