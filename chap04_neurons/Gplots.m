...
% % Green's function on finite domain: method of images. Short-Circuit ends.
% [T,X] = meshgrid(tau:0.005:tau+0.2,0:L/200:L);
% Z = GMISC(T,X,xi,tau,L);
% figure(4)
% subplot(2,1,1)
% surf(T,X,Z)
% xlabel('T')
...
% subplot(2,1,2)
% plot(xf,Vf1,xf,Vf2,xf,Vf3,'LineWidth',2)
% ylim([0,25])
...
% Base term in Fourier expansion
